...
public class ArticlePage<T> {
	...
	public ArticlePage(int total, int currentPage, int size, List<T> content, String keyword) {
		...
		pagingArea += "<a href='" + this.url + "?currentPage=" + (this.startPage - 5) + "&keyword=" + this.keyword
				+ "' aria-controls='example2' data-dt-idx='0' tabindex='0' style='width: 55px;'";
		...
		pagingArea += "href='" + this.url + "?currentPage=" + (this.startPage + 5) + "&keyword=" + this.keyword
				+ "' aria-controls='example2' data-dt-idx='7'  style='width: 55px;'";
	...
	//ajax전용 생성자
	public ArticlePage(int total, int currentPage, int size, List<T> content, String keyword, String mode, int nn) {
		// size : 한 화면에 보여질 목록의 행 수
		this.total = total;// 753
		this.currentPage = currentPage;// 1
		this.content = content;
		...
		pagingArea += "'";
		pagingArea += "id='example2_previous'>";
		pagingArea += "<a href='#' style='width: 55px;' onclick=\"getList('" + this.keyword +"', " + (this.startPage - 5) + ")\" aria-controls='example2' data-dt-idx='0' tabindex='0' ";
		pagingArea += "class='page-link'>이전</a></li>";
		...
		pagingArea += "' id='example2_next'><a ";
		pagingArea += "href='#' style='width: 55px;' onclick=\"getList('" + this.keyword +"', " + (this.startPage + 5) + ")\" aria-controls='example2' data-dt-idx='7' ";
		pagingArea += "tabindex='0' class='page-link'>다음</a></li>";
		pagingArea += "</ul>";
		pagingArea += "</div>";
		pagingArea += "</div>";
	...
	//게시판 카테고리가 추가된 페이징
	public ArticlePage(int total, int currentPage, int size, List<T> content, String keyword,String boardCat) {
			// size : 한 화면에 보여질 목록의 행 수
			this.total = total;// 753
			this.currentPage = currentPage;// 1
			this.content = content;
	...
	// 관리비 미납자 용 페이지
	public ArticlePage(int total, int currentPage, int size, List<T> content, String keyword,boolean payYn) {
		// size : 한 화면에 보여질 목록의 행 수
		this.total = total;// 753
		this.currentPage = currentPage;// 1
		this.content = content;
