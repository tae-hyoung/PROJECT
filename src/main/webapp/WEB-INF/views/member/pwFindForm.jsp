                    ...
                    <div class="card mt-4 card-bg-fill">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <h5 class="text-primary">비밀번호 재발급</h5>
                            </div>
                            <div class="p-2 mt-4">
                                <div class="mb-3">
                                    <label for="memId" class="form-label">아이디</label>
                                    <input type="text" class="form-control" id="memId" name="memId" placeholder="회원아이디">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="mt-4 text-end">
                                <a href="/login" class="fw-semibold text-primary text-decoration-underline"> 로그인 </a>
                            </div>
                        </div>
                        <!-- end card body -->
                    </div>
