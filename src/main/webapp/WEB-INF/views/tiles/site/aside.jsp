...
<!-- 			<a href="#" class="btn btn-secondary">로그아웃</a> -->
	...
	<div class="sidebar-menu">
		<ul class="menu">
			...
			<li class="sidebar-item " id="introduce">
...
<!-- 					</svg> -->
			...
			<li class="sidebar-item " id="danji">
				<a href="/site/danji" class="sidebar-link">
			...
			<li class="sidebar-item " id="notice">
				<a href="/site/notice?boardCat=board_site" class="sidebar-link">
			...
			<li class="sidebar-item " id="bid">
				<a href="/site/bidList" class="sidebar-link">
