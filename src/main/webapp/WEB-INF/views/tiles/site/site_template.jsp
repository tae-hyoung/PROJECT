...
<head>
    ...
    <title>SweetHome</title>
		...
		<link
			...
			rel="stylesheet">
		<link rel="stylesheet" href="/resources/aside/css/bootstrap.css">
		<link rel="stylesheet" href="/resources/aside/css/bold.css">
		<link rel="stylesheet" href="/resources/aside/css/bootstrap-icons.css">
		<link rel="stylesheet" href="/resources/aside/css/app.css">
		<!-- 사이드바 CSS 끝 -->
...
<!--     <script src="/resources/sbadmin/js/demo/chart-pie-demo.js"></script> -->
		...
		<!-- sidebar JS 시작 -->
		<script src="/resources/aside/js/apexcharts.js"></script>
		<script src="/resources/aside/js/bootstrap.bundle.min.js"></script>
		<script src="/resources/aside/js/dashboard.js"></script>
		<script src="/resources/aside/js/main.js"></script>
		<script src="/resources/aside/js/perfect-scrollbar.min.js"></script>
		<!-- sidebar JS 끝 -->
