...
(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/french.svg";
			} else if (lang == "ae") {
				document.getElementById("header-lang-img").src = "/resources/assets/images/flags/ae.svg";
			}
	...
	function getLanguage() {
		...
		request.open("GET", "/resources/assets/lang/" + language + ".json");
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="/resources/assets/images/logo-sm.png" alt="" height="22"></a>';
						...
						if (!emptyNotificationElem) {
							elem.innerHTML += '<div class="empty-notification-elem">\
								<div class="w-25 w-sm-50 pt-3 mx-auto">\
									<img src="/resources/assets/images/svg/bell.svg" class="img-fluid" alt="user-pic">\
								</div>\
